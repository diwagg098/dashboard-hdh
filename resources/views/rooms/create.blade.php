...
<div class="main-panel">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card-header card-header-primary">
                <h4 class="card-title "> Create Rooms Table</h4>
                <p class="card-category"> Dashboard / Table Rooms / Create</p>
            </div>
            <div class="card-body">
                <div class="testbox">
    ...
    <div class="item">
        <p>Nama Kamar</p>
        <input type="text" name="nama_kamar" placeholder="Nama Kamar"/>
        @error('nama_kamar')
    ...
    <div class="customer_records item" style="color: green;">
        <p>Fitur</p>
        <input name="fitur[]" type="text" placeholder="fitur">
        <a class="extra-fields-customer btn btn-primary" href="#">Add More Fitur</a>
    </div>
